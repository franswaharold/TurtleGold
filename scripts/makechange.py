...
Open the wallets with TurtleGold-service like so:

./TurtleGold-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./TurtleGold-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
